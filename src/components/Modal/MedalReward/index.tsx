...
const TipsSvg = (
  <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M5.82 10V4.66H7.07V10H5.82ZM6.45 3.78C6.21667 3.78 6.02333 3.70667 5.87 3.56C5.72333 3.41333 5.65 3.23667 5.65 3.03C5.65 2.81667 5.72333 2.64 5.87 2.5C6.02333 2.35333 6.21667 2.28 6.45 2.28C6.68333 2.28 6.87333 2.35 7.02 2.49C7.17333 2.62333 7.25 2.79333 7.25 3C7.25 3.22 7.17667 3.40667 7.03 3.56C6.88333 3.70667 6.69 3.78 6.45 3.78Z"
      fill="#979ABE"
    />
  </svg>
);
const GemSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" viewBox="0 0 29 29" fill="none">
    <path
      d="M17.0065 0.256348L28.7433 11.9932V17.2628L17.0065 28.9996H11.7368L0 17.2628V11.9932L11.7368 0.256348H17.0065Z"
      fill="#F4DC27"
    />
    ...
    <rect
      ...
      height="15.1588"
      rx="3"
      transform="rotate(-45 3.81976 14.6404)"
      fill="#F4DC27"
    />
  </svg>
);
const StarSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="15" viewBox="0 0 19 15" fill="none">
    <path
      d="M7.20773 1.74707L8.82235 6.56461L13.6399 8.17923L8.82235 9.79385L7.20773 14.6114L5.59311 9.79385L0.775574 8.17923L5.59311 6.56461L7.20773 1.74707Z"
      fill="#F4DC27"
    />
    <path
      d="M15.2479 0.675049L16.1898 3.28455L19 4.15914L16.1898 5.03372L15.2479 7.64322L14.3061 5.03372L11.4958 4.15914L14.3061 3.28455L15.2479 0.675049Z"
      fill="#F4DC27"
    />
  </svg>
);
const ArrowSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" width="19" height="17" viewBox="0 0 19 17" fill="none">
    <path
      d="M7.76795 16C8.53775 17.3333 10.4623 17.3333 11.2321 16L18.5933 3.25C19.3631 1.91667 18.4008 0.25 16.8612 0.25H2.13878C0.599184 0.25 -0.363067 1.91667 0.406733 3.25L7.76795 16Z"
      fill="#EBF479"
    />
  </svg>
);
...
const Tips = function ({ tips }: { tips: string }) {
  ...
  return (
    ...
    >
      <StyledSvg style={{ cursor: 'pointer' }}>{TipsSvg}</StyledSvg>
      {boundingClientRect && (
      ...
      <StyledMedalRewardTop>
        <StyledUser>
          ...
          <StyledFlex flexDirection="column" alignItems="flex-start" gap="9px">
            {twitterUsername ? (
              <>
                <StyledFont color="#FFF" fontSize="18px" fontWeight="600">
                  {twitterUsername}
                </StyledFont>
          ...
          <StyledLegacyContainer>
            {LegacyList.map((legacy) => (
              <StyledLegacy key={legacy.label}>
                ...
                <StyledLegacyValue>
                  {formatValueDecimal(convert ? convert[legacy?.key] : 0, legacy?.unit ?? '', legacy?.decimal ?? 0)}{' '}
                  {legacy?.key === 'pts' ? 'PTS' : ''}
                </StyledLegacyValue>
              </StyledLegacy>
            ))}
        ...
        <StyledGemsAndMedals>
          <StyledGems>
            ...
            <StyledFlex gap="13px">
              ...
              <StyledFont color="#FFF" fontWeight="600">
                x <Counter from={1} to={convert?.gem ?? 0} />
              </StyledFont>
            </StyledFlex>
          </StyledGems>
          <StyledMedals>
...
const MedalRewardModal = (props: Props) => {
  ...
  return (
    <Modal
      ...
      portal={true}
      width={680}
      content={<MedalRewardModalContent onClose={onClose} />}
    />
  );
};
