  ...
  return (
    <StyledCheckConverting>
      ...
      <StyledCheckConvertingBottom>
        <StyledFont color="#FFF" fontSize="24px" fontWeight="700" style={{ marginBottom: 14 }}>
          Medal System Now Live!
        </StyledFont>
        <StyledFont color="#979ABE" lineHeight="150%">
          Your transaction volume, engagement, referrals, and PTS have been converted into medals. Activate them now to
          earn gem rewards, which determine your airdrop amount. You have one month to manually convert your PTS before
...
const CheckConvertingModal = (props: Props) => {
  ...
  return (
    <Modal
      ...
      portal={true}
      width={680}
      content={<CheckConvertingContent onClose={onClose} onCheck={onCheck} />}
    />
  );
};
