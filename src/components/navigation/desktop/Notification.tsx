    ...
    return <Wrapper>
        ...
        <Layer>
            ...
            <div className="noti-content">
                {
                    arr.map(item => {
                        return <NotificationItem key={item}/>
                    })
                }
            </div>
        </Layer>
