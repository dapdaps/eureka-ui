    ...
    <StyledContainer style={{ paddingLeft: 24, paddingRight: 20, paddingTop: 20 }}>
      <StyledFlex flexDirection="column" gap="31px">
        <StyledFlex justifyContent="space-between" style={{ width: '100%' }}>
          <StyledFont fontWeight="700" color="#FFF">
            Your Invite Link
          </StyledFont>
          <StyledFont
            fontWeight="500"
          ...
          >
            {userInfo?.total_invited} invited
          </StyledFont>
        </StyledFlex>
        <StyledLink>
          <StyledSvg>
            <svg width="308" height="53" viewBox="0 0 308 53" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M8 0H249.615C249.767 1.51433 251.046 2.69653 252.6 2.69653C254.155 2.69653 255.433 1.51433 255.585 0H300C304.418 0 308 3.58172 308 8V45C308 49.4183 304.418 53 300 53H255.555C255.309 51.5911 254.08 50.5203 252.6 50.5203C251.121 50.5203 249.891 51.5911 249.645 53H8C3.58172 53 0 49.4183 0 45V8C0 3.58172 3.58172 0 8 0Z"
                fill="url(#paint0_linear_7047_6093)"
              />
              <line
                x1="252.5"
                y1="4.5"
