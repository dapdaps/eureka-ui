          ...
          <GridContainer className="pool-head">
            <GridItem>
              <div className="title-primary">
                <Avatar src={TOKENS[tokenAddress]?.icon} />
            ...
            <GridItem>
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <Avatar src={TOKENS[tokenAddress]?.icon} size={18} />
            ...
            <GridItem>
              <div className="title-secondary">${!Number(rewardAmount) ? 0 : rewardAmount}</div>
              <div className="title-sub"></div>
            </GridItem>
          </GridContainer>
          ...
          <Tabs.Content value="INFO_TAB">
            <InfoPanel>
              ...
              <InfoPanelList>
                ...
                <a className="list-value" target="_blank" href={`${EXPLORER}/token/${tokenAddress}`}>
                  {tokenAddress}
                </a>
              </InfoPanelList>
              <InfoPanelList>
                <span className="list-key">Locking:</span>
                <a className="list-value" target="_blank" href={`${EXPLORER}/address/${StakingAddress}`}>
                  {StakingAddress}
                </a>
              </InfoPanelList>
            </InfoPanel>
