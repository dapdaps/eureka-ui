...
export default memo(function Positions(props: any) {
  ...
  function handleQueryDashboard() {
    ...
    multicall({
      ...
      .then((result) => {
        const [getAccountHealthResult, getDebtAmountResult, balanceOfAssetsResult] = result;
    ...
    <StyledContainer>
      ...
      <StyledPostionsContainer>
        ...
        <StyledPostionsBottom>
          {state.filterVaults?.length > 0 ? (
            state.filterVaults.map((vault, index) => (
              <StyledPosition key={index}>
                ...
                >
                  <StyledPositionColumnImageContainer style={{ backgroundColor: vault.iconBgColor }}>
                ...
                >
                  <StyledPositionColumnTxt>
                    {'$' +
                      Big(vault?.positionValue ?? 0)
                        .times(prices[SECOND_SYMBOL_NAME])
                        .toFixed(2)}
                  </StyledPositionColumnTxt>
                </StyledPositionColumn>
                <StyledPositionColumn
            ...
            <StyledNotHave>You didn’t add any vault yet</StyledNotHave>
          )}
        </StyledPostionsBottom>
      </StyledPostionsContainer>
    </StyledContainer>
