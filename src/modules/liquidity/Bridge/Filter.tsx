      ...
      <StyledTipsAndPoolsContainer>
        {
          from === 'layer' && isDapps && (
            <StyledTips>
              <StyledTipsFirstTxt>Liquidity</StyledTipsFirstTxt>
              <StyledTipsSecondTxt>Seamlessly adding LP to any pair.</StyledTipsSecondTxt>
            </StyledTips>
          )
        }
        ...
        <ChainsOrMarketsWrapper className={[from, isDapps ? 'isDapps' : ''].join(' ')}>
          {
            isDapps ? (
              // <Widget
              //   src={"bluebiu.near/widget/Liquidity.Bridge.Markets"}
              //   props={{
              //     from,
              //     markets,
              //     currentMarket,
                  ...
                  <StyledLayerChainsWrap>
                    <StyledLayerChains>
                      {chains && chains.map((chain: any, index: number) => {
                        return <StyledLayerChain key={index} className={index === chainIndex ? 'active' : ''} onClick={() => onChangeChainIndex(index)}>
