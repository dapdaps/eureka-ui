...
import CompoundV3Asset from '@/modules/lending/CompoundV3/Asset';
import {
  StyledAssetIcon,
  StyledAssets,
  StyledExpand,
  ...
  StyledRowHeader,
  StyledRowItem
} from '@/modules/lending/CompoundV3/TableRow/styles';
import CompoundV3UsdPrice from '@/modules/lending/CompoundV3/UsdPrice';
import CompoundV3Utilization from '@/modules/lending/CompoundV3/Utilization';
        ...
        {columns.map((column: any) => (
          <StyledRowItem key={column.key} style={{ width: column.width }}>
            ...
            {column.key === 'utilization' && (
              <CompoundV3Utilization value={Big(data.utilization).toFixed(2)} />
            )}
            {column.key === 'earnApr' && (
              <>
            ...
            {column.type === 'price' && (
              <CompoundV3UsdPrice price={data[column.key]} />
            )}
