...
import { StyledInfo, StyledInfoContent, StyledInfoItem, StyledInfoTips, StyledInfoTitle } from './styles';
      ...
      <StyledInfoContent>
        ...
        <StyledInfoItem>
          ...
          <div>
            <span className="white">
              <LendingTotal total={userUnderlyingBalance} digit={2} unit="" />
            </span>{' '}
        ...
        {dexConfig.name === 'Ionic' && (
          <StyledInfoItem>
            <div>Min Borrow</div>
            <div>
              <span className="white">{minBorrowAmount}</span> {underlyingToken?.symbol}
            </div>
          </StyledInfoItem>
        )}
        <StyledInfoTips>
          {from === 'layer' ? (
            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
              ...
              <path d="M7.5 7.5L7.5 11.25" stroke="#6F6F6F" strokeWidth="1.4" strokeLinecap="round" />
