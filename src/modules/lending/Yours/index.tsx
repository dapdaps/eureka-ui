...
import LendingBorrowTable from '@/modules/lending/Yours/BorrowTable';
import LendingDepositTable from '@/modules/lending/Yours/DepositTable';
import LendingRewardsTable from '@/modules/lending/Yours/RewardsTable';
