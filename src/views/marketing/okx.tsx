...
interface IProps {
  from: 'bg' | 'bgUser';
  inviteCode?: string;
  platform: 'bitget' | 'coin68' | 'namlongdao' | 'okx';
}
    ...
    <Styles.Container>
      <Styles.Banner className={platform}>
        <Styles.Logo>
          ...
          {/* <div className="dapdap">DapDap</div> */}
          <Styles.XImg src="/images/marketing/X.svg" />

          <Styles.OkxImg src={logoMap.get(platform)} />
          <div className="partner">OKX Wallet</div>
        </Styles.Logo>
        <Styles.Intro>Ready to Claim Your Exclusive Rewards?Just Connect Your Wallet!</Styles.Intro>
