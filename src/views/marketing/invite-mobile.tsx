...
import * as Styles from './invite-mobile-styles';
...
const LandingMobile: FC<IProps> = ({ kolName, platform }) => {
  ...
  return (
    <Styles.Container>
      <Styles.Banner>
        <Styles.Brand>Join DapDap</Styles.Brand>
        <Styles.Intro>to earn points and more rewards</Styles.Intro>
      </Styles.Banner>
      <Styles.Box>
        <Styles.CapWrap>
          <Styles.Cap src="/images/marketing/cap.svg"></Styles.Cap>
          {/* <Styles.HelpBox>
            <Styles.Help src="/images/marketing/help.svg" />
          </Styles.HelpBox> */}
        </Styles.CapWrap>
