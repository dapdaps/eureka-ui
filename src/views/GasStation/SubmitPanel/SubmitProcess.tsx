...
export default function SubmitPanel({
    fromChain, toChain, onClose
}: Props) {
    return <Modal onClose={onClose} width={596} paddingSize={0}>
        <TopSum>
            <img src={fromChain?.icon} className="gas-chain" />
            <div className="gas-line"></div>
            <div className="gas-text">0.01882 ETH</div>
            <div className="gas-line"></div>
            ...
            <div className="address-content">
                <div className="address-item">
                    <div className="account-wapper">
                        <div>0x3bCBb26DBA595b6B52379DD006614c01087AB717</div>
        ...
        <Progress>
            <CircleGroup>
                <Circle className="circle" disabled={false}>
                    &uarr;
                </Circle>
                ...
                <div className="circle-line" />
                <Circle className="circle" disabled={true}>
                    &radic;
                </Circle>
            </CircleGroup>
            <GroupText>
                <div className="text">Waiting for transac</div>
