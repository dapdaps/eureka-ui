...
export const StyledInput = styled.div<{ $error?: boolean; $focus: boolean }>`
  margin-top: 10px;
  border-radius: 12px;
  transition: 0.5s;
  background: ${({ $error, $focus }) => ($focus ? '#1B1E27' : $error ? 'rgba(255, 157, 151, 0.10)' : '#2E3142')};
  height: 100px;
  padding: 18px 16px 8px 14px;
  border: 1px solid ${({ $error, $focus }) => ($focus ? '#373A53' : $error ? '#FF9D97' : '#373A53')};
`;
