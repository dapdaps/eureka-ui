...
function TokenSelectModal({
  ...
  return (
    <Modal ref={wapperRef} fixed paddingSize={0} onClose={onClose}>
      <Container>
        <ChainWapper>
...
export default function WapperToken(props: any): any {
  return ReactDOM.createPortal(<TokenSelectModal {...props} />, document.body);
}
