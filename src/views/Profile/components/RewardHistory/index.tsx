      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
          <rect
            ...
            height="48"
            rx="10"
            transform={pager.page === 1 ? 'matrix(-1 0 0 1 48 0)' : ''}
            fill="#101115"
          />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M26.6907 29.8186C27.0461 29.5331 27.1037 29.0123 26.8194 28.6554L23.1107 24L26.8194 19.3446C27.1037 18.9877 27.0461 18.4669 26.6907 18.1814C26.3353 17.8959 25.8167 17.9537 25.5324 18.3106L21 24L25.5324 29.6894C25.8167 30.0463 26.3353 30.1041 26.6907 29.8186Z"
            fill="#979ABE"
          />
        </svg>
      </StyledSvg>
        ...
        {new Array(maxPage).fill('').map((_, index) => {
          ...
          return (
            ...
            >
              ...
              <StyledPageNumber style={{ color: pageNumber === pager?.page ? '#FFF' : '#979ABE' }}>
                {pageNumber}
              </StyledPageNumber>
            </StyledPageNumberContainer>
          );
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
          <rect
            ...
            height="48"
            rx="10"
            transform={pager.page === maxPage ? 'matrix(-1 0 0 1 48 0)' : ''}
            fill="#101115"
          />
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M21.3093 29.8186C20.9539 29.5331 20.8963 29.0123 21.1806 28.6554L24.8893 24L21.1806 19.3446C20.8963 18.9877 20.9539 18.4669 21.3093 18.1814C21.6647 17.8959 22.1833 17.9537 22.4676 18.3106L27 24L22.4676 29.6894C22.1833 30.0463 21.6647 30.1041 21.3093 29.8186Z"
            fill="#979ABE"
          />
        </svg>
      </StyledSvg>
...
export default function RewardHistory({ loaded, userRewardRecords, pager, maxPage, onPageChange }: PropsType) {
        ...
        {userRewardRecords?.data?.map((record: RewardType, index: number) => {
          return (
            <StyledRecord key={index}>
              ...
              <StyledFont color="#FFF" style={{ flex: 1 }}>
                {format(new Date(record?.created_at), 'MMM dd, u, HH:mm')}
              </StyledFont>
            </StyledRecord>
          );
        })}
