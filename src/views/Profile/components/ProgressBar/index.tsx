...
import { StyledAchieved, StyledAchievedContainer, StyledInnerProgressBar, StyledProgressBar } from './styles';
  ...
  return (
    ...
    >
      ...
      <StyledFont color="#979ABE" fontSize="14px" fontWeight="500" style={{ position: 'absolute', right: 0 }}>
        {tooltip ? <SimpleTooltip tooltip={tooltip}>{renderRatio()}</SimpleTooltip> : renderRatio()}
      </StyledFont>
    </StyledFlex>
  );
}
