...
import { StyledContainer, StyledItem, StyledItemBg, StyledItemColorBg, StyledItemComing } from './styles';
...
const QuickOnboarding = ({ path, chain }: any) => {
        ...
        >
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="16" viewBox="0 0 28 16" fill="none">
            <path
              ...
              fill={item.key === 'Chain-Navi' ? '#02051E' : 'white'}
            />
          </svg>
        </StyledItem>
      ))}
