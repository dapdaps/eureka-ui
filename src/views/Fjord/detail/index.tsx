              ...
              pool?.status === "upcoming" ? (
                <StyledSiderContent>
                  ...
                  <StyledContainer style={{ paddingTop: 15 }}>
                    ...
                    >Add {token?.symbol} to MetaMask</StyledFont>
                  </StyledContainer>
                </StyledSiderContent>
                ...
                <StyledSiderContent>
                  ...
                  <StyledFont color='#979ABE' fontSize='14px' style={{ width: 470, marginTop: 20, marginBottom: 20 }}>
                    Tokens purchased with and without vesting in a V2 LBP must be redeemed by clicking the &apos;Redeem Tokens&apos; button below at the end of the LBP
                  </StyledFont>
                  <StyledFont color='#979ABE' fontSize='14px' style={{ width: 470 }}>
                    If the LBP you participated in has vested tokens, you can view the token stream via Sablier using the link below.
                  </StyledFont>
                  <StyledFlex justifyContent='space-between' style={{ width: 458, marginTop: 20, marginBottom: 22 }}>
                    <StyledFont color='#979ABE' fontSize='14px'>Purchased Shares:</StyledFont>
                    <StyledFont color='#FFF' fontSize='14px'>{formatValueDecimal(shares, '', 3)}</StyledFont>
                  </StyledFlex>
                  ...
                  <StyledFlex justifyContent='space-between' style={{ paddingTop: 15, width: 470, }}>
                    <StyledFlex gap='6px'>
                      <StyledFont color='#979ABE' fontSize='14px'>View on chain</StyledFont>
                      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
                        <g clip-path="url(#clip0_13116_4836)">
                          ...
                          <path d="M9.08638 0.222534L9.77335 0.909497L5.33931 5.33572L4.66016 4.65657L9.08638 0.222534Z" fill="#979ABE" />
                          <path d="M9.98394 2.97034H9.01594V0.971899H6.92383V0.00390625H9.99174L9.98394 2.97034Z" fill="#979ABE" />
                        </g>
                        <defs>
                ...
                <StyledSiderContent>
                  ...
                  <StyledFlex justifyContent='space-between' style={{ width: 458, marginTop: 20, marginBottom: 22 }}>
                    <StyledFont color='#979ABE' fontSize='14px'>Purchased Shares:</StyledFont>
                    <StyledFont color='#FFF' fontSize='14px'>0.123</StyledFont>
                  </StyledFlex>
                  <StyledSiderButton>
                    <svg xmlns="http://www.w3.org/2000/svg" width="17" height="20" viewBox="0 0 17 20" fill="none">
                      <path d="M3.71933 2.39646L3.51451 1.67258C3.35312 1.10218 3.69054 0.502112 4.26694 0.339023C4.84198 0.176321 5.44515 0.51025 5.60654 1.08066L5.81136 1.80453C9.00177 1.45189 11.545 3.68799 12.4768 6.98141L13.6066 10.9743L16.2558 12.1844C16.7704 12.6651 16.906 13.1079 16.7352 13.7899C16.5666 14.4742 15.9794 14.7195 15.299 14.9121L2.50582 18.5318C1.82536 18.7243 1.19672 18.823 0.693905 18.3316C0.192465 17.8398 0.0752398 17.3889 0.261053 16.7129L0.282649 16.6481L1.86943 14.2967L0.739683 10.3038C-0.19217 7.0104 0.814379 3.76846 3.71933 2.39646ZM10.8045 16.7969C11.0747 17.7516 10.6078 19.0807 9.64534 19.353C8.68285 19.6253 7.58888 18.7379 7.31874 17.7832L10.8045 16.7969Z" fill="white" />
