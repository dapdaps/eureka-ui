...
import { StyledContainer, StyledFlex, StyledFont, StyledLoadingWrapper, StyledSvg } from '@/styled/styles';
...
const StyledFjordSvgContainer = styled.div`
  ...
  &:after {
    ...
    border-radius: 600px;
    opacity: 0.3;
    background: radial-gradient(50% 50% at 50% 50%, #543dc9 0%, rgba(84, 61, 201, 0) 100%);
    filter: blur(25px);
    z-index: 10;
  }
  svg {
...
const FjordSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" width="98" height="30" viewBox="0 0 98 30" fill="none">
    ...
    <path
      d="M21.6066 0H8.20589C3.67302 0 0 3.6684 0 8.1953V29.9999H5.28357V8.1953C5.28357 6.58281 6.59131 5.27687 8.20589 5.27687H21.6066V0Z"
      fill="url(#paint1_linear_15098_1236)"
    />
    <path
      d="M0 11.8395C0 10.2271 2.4461 5.27687 8.20589 5.27687H21.6066V0H8.20589C3.67302 0 0 3.6684 0 8.1953V11.8395Z"
      fill="url(#paint2_linear_15098_1236)"
    />
    <path
      d="M27.0356 0V17.8339C27.0356 21.6393 23.9478 24.7231 20.1375 24.7231H12.8518V29.9999H20.1091C26.854 29.9999 32.3192 24.5418 32.3192 17.8057V0H27.0356Z"
      fill="url(#paint3_linear_15098_1236)"
    />
    <path
      d="M32.3232 15.0391C32.3232 18.8445 28.9851 24.7219 20.1415 24.7219H12.8518V29.9988H20.1091C26.8539 29.9988 32.3192 24.5405 32.3192 17.8045V15.0391H32.3232Z"
      fill="url(#paint4_linear_15098_1236)"
    />
    <path
      d="M54.1315 0H45.2234C41.1225 0 37.7964 3.32175 37.7964 7.41731V29.9999H43.0801V7.30445C43.0801 6.18383 43.9883 5.27672 45.1104 5.27672H54.1315V0Z"
      fill="url(#paint5_linear_15098_1236)"
    />
    <path
      d="M45.2234 0C41.1225 0 37.7964 3.32175 37.7964 7.41731V29.9999H43.0801V7.30445C43.0801 4.90591 44.2022 0 48.5049 0H45.2234Z"
      fill="url(#paint6_linear_15098_1236)"
    />
    <path
      d="M43.0801 29.9999H51.9882C56.0892 29.9999 59.4152 26.6782 59.4152 22.5826V0H54.1315V22.6955C54.1315 23.8161 53.2233 24.7231 52.1012 24.7231H43.0801V29.9999Z"
      fill="url(#paint7_linear_15098_1236)"
    />
    <path
      d="M51.9924 29.9999C56.0934 29.9999 59.4194 26.6782 59.4194 22.5826V0H54.1359V22.6955C54.1359 25.094 53.0137 29.9999 48.7109 29.9999H51.9924Z"
      fill="url(#paint8_linear_15098_1236)"
    />
    <path
      d="M70.1762 29.9999V12.1661C70.1762 8.36065 73.264 5.27687 77.0743 5.27687H84.36V0H77.1026C70.3578 0 64.8926 5.45817 64.8926 12.1943V29.9999H70.1762Z"
      fill="url(#paint9_linear_15098_1236)"
    />
    <path
      d="M64.8926 14.9596C64.8926 11.1541 68.2307 5.27687 77.0743 5.27687H84.36V0H77.1026C70.3578 0 64.8926 5.45817 64.8926 12.1943V14.9596Z"
      fill="url(#paint10_linear_15098_1236)"
    />
    <path
      d="M91.9282 10.8887H83.0199C78.9189 10.8887 75.593 14.2104 75.593 18.306V30.0005H80.8766V18.1971C80.8766 17.0765 81.7847 16.1696 82.9069 16.1696H91.9282V10.8887Z"
      fill="url(#paint11_linear_15098_1236)"
    />
    <path
      d="M83.0199 10.8887C78.9189 10.8887 75.593 14.2104 75.593 18.306V30.0005H80.8766V18.1971C80.8766 15.7986 81.9987 10.8928 86.3015 10.8928H83.0199V10.8887Z"
      fill="url(#paint12_linear_15098_1236)"
    />
    <path
      d="M80.8765 29.9999H89.7848C93.8857 29.9999 97.2116 26.6782 97.2116 22.5826V0H91.928V22.6955C91.928 23.8161 91.0199 24.7231 89.8978 24.7231H80.8765V29.9999Z"
      fill="url(#paint13_linear_15098_1236)"
    />
    <path
      d="M89.7848 29.9999C93.8857 29.9999 97.2117 26.6782 97.2117 22.5826V0H91.9281V22.6955C91.9281 25.094 90.806 29.9999 86.5032 29.9999H89.7848Z"
      fill="url(#paint14_linear_15098_1236)"
    />
    <defs>
      <linearGradient
        id="paint0_linear_15098_1236"
        x1="19.4179"
        y1="14.9996"
        x2="5.28459"
        y2="14.9996"
...
const ChainList = function (props: any) {
  const { chainId, setChainId, poolsMapping } = props;
  return (
              ...
              {_chainId === chainId && (
                <StyledSvg style={{ position: 'absolute', right: 10, top: 16 }}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="10" viewBox="0 0 14 10" fill="none">
                    <path d="M1 4.11111L5.28571 8L13 1" stroke="#EBF479" stroke-width="2" stroke-linecap="round"></path>
                  </svg>
                </StyledSvg>
              )}
            </StyledChain>
...
export default function LaunchpadHomePage() {
  ...
  return (
    <>
      <StyledContainer
        style={{ width: 1124, margin: '0 auto', paddingTop: 138, position: 'relative', minHeight: viewHeight }}
      >
        <StyledContainer style={{ position: 'absolute', left: 0, top: 30 }}>
          <DappBack defaultPath="/alldapps" />
        </StyledContainer>
        <StyledFjordSvgContainer>{FjordSvg}</StyledFjordSvgContainer>
        <StyledYoursContainer>
          ...
          >
            <StyledFlex flexDirection="column" alignItems="flex-start" gap="13px" style={{ flex: 1 }}>
              <StyledFont color="#979ABE" fontSize="18px" fontWeight="500">
                Your Total Cost
              </StyledFont>
              <StyledFont color="#FFF" fontSize="26px" fontWeight="500">
                {formatValueDecimal(user?.total_cost ?? 0, '$', 4)}
              </StyledFont>
            </StyledFlex>
            <StyledFlex flexDirection="column" alignItems="flex-start" gap="13px" style={{ flex: 1 }}>
              <StyledFont color="#979ABE" fontSize="18px" fontWeight="500">
                Your Avg. Rate of Return
              </StyledFont>
              <StyledFont color="#FFF" fontSize="26px" fontWeight="500">
                {Big(user?.rate_return_avg ?? 0).toFixed(0)}%
              </StyledFont>
            </StyledFlex>
            {user?.lbps?.length > 0 && (
              <StyledFlex flexDirection="column" alignItems="flex-start" gap="13px" style={{ flex: 1 }}>
            ...
            <StyledFlex>
              <svg xmlns="http://www.w3.org/2000/svg" width="7" height="10" viewBox="0 0 7 10" fill="none">
                <path
                  d="M6.52391 4.21913C7.02432 4.61945 7.02432 5.38054 6.52391 5.78087L1.6247 9.70024C0.969933 10.2241 -4.70242e-07 9.75788 -4.3359e-07 8.91937L-9.0947e-08 1.08062C-5.42947e-08 0.242118 0.969932 -0.224055 1.62469 0.299755L6.52391 4.21913Z"
                  fill="#979ABE"
                />
              </svg>
            </StyledFlex>
        ...
        <StyledProjectContainer>
          <StyledFlex justifyContent="space-between">
            ...
            <StyledFlex gap="15px">
              ...
              <StyledPoolStatusContainer>
                ...
                <StyledPoolStatus
                  className={poolStatusIndex === 1 ? 'active' : ''}
          ...
          <StyledFlex flexDirection="column" gap="30px">
            ...
            ) : upcomingAndOngoingPools && upcomingAndOngoingPools.length > 0 ? (
              upcomingAndOngoingPools.map((pool: any, index: number) => (
                  ...
                  <StyledContainer style={{ flex: 1, paddingTop: 16 }}>
                    <StyledFlex alignItems="flex-start" gap="16px">
                      ...
                      <StyledFlex flexDirection="column" alignItems="flex-start" gap="9px">
                        <StyledFont color="#FFF" fontSize="32px" fontWeight="600">
                          {pool.share_token_symbol}
                        </StyledFont>
                        <StyledFont color="#979ABE" fontSize="14px" fontWeight="500">
                          {pool.share_token_name}
                        </StyledFont>
                      </StyledFlex>
                    </StyledFlex>
                    <StyledFlex justifyContent="space-between" style={{ marginTop: 106, marginBottom: 30 }}>
                      <StyledFlex flexDirection="column" alignItems="flex-start" gap="10px">
                        ...
                        <StyledFont color="#FFF" fontSize="20px" fontWeight="700">
                          {formatValueDecimal(pool?.total_participants)}
                        </StyledFont>
                      </StyledFlex>
                      <StyledFlex flexDirection="column" alignItems="flex-start" gap="10px">
                        <StyledFont color="#FFF" fontSize="16px" fontWeight="500">
                        ...
                        <StyledFont color="#FFF" fontSize="20px" fontWeight="700">
                          {formatValueDecimal(pool?.funds_raised_usd ?? 0, '$', 2, true)}
                        </StyledFont>
                      </StyledFlex>
                      <StyledFlex flexDirection="column" alignItems="flex-start" gap="10px">
                        <StyledFont color="#FFF" fontSize="16px" fontWeight="500">
                        ...
                        <StyledFont color="#FFF" fontSize="20px" fontWeight="700">
                          {formatValueDecimal(pool?.price_usd ?? 0, '$', 3)}
                        </StyledFont>
                      </StyledFlex>
                      {pool?.share_token_name === 'RAGE' && (
                        <StyledFlex flexDirection="column" alignItems="flex-start">
                          ...
                          <StyledFont color="#FFF" fontSize="20px" fontWeight="700">
                            {formatValueDecimal(contractDataMapping[pool?.pool]?.purchased_shares ?? 0, '', 3)}
                          </StyledFont>
                        </StyledFlex>
                      )}
                    </StyledFlex>
                    <StyledFlex>
                      {pool?.share_token_name === 'RAGE' ? (
                        <StyledFlex flexDirection="column" alignItems="flex-start">
                          <StyledSpecitalReward>
                            ...
                            <StyledSpecitalRewardTips>
                              The first 100 buyers will get 500 PTS for each
                            </StyledSpecitalRewardTips>
                          </StyledSpecitalReward>
                          ...
                          <StyledFlex gap="9px">
                            <StyledSpecitalReward>
                              <StyledFont color="#FFF" fontSize="20px" fontWeight="700">
                                {Math.min(pool?.buy_part ?? 0, 100)}/100
                              </StyledFont>
                              <StyledSpecitalRewardTips
                                style={{ bottom: -6, top: 'unset', right: '50%', transform: 'translate(50%, 100%)' }}
                              >
                                There are {Math.min(pool?.buy_part ?? 0, 100)} users got spcial reward currently
                              </StyledSpecitalRewardTips>
                            </StyledSpecitalReward>
                      ...
                      <StyledProjectButtonContainer>
                        ...
                        >
                          {pool.status === 'upcoming' ? 'Coming Soon' : 'Buy Now'}
                        </StyledProjectButton>
                        <StyledProjectButton
                          onClick={() => {
          ...
          <StyledCompletedSalesTable>
                  ...
                  {column?.sortable && (
                    <StyledSvg>
                      <svg xmlns="http://www.w3.org/2000/svg" width="10" height="8" viewBox="0 0 10 8" fill="none">
                        <path
                          d="M5.78087 7.02391C5.38055 7.52432 4.61946 7.52432 4.21913 7.02391L0.299758 2.1247C-0.224053 1.46993 0.242119 0.499999 1.08063 0.499999L8.91938 0.5C9.75788 0.5 10.2241 1.46993 9.70024 2.12469L5.78087 7.02391Z"
                          fill={sortKey === column.key ? '#FFF' : '#979ABE'}
                        />
                      </svg>
                    </StyledSvg>
                  )}
            ...
            <StyledCompletedSalesTBody>
              {loading ? (
                ...
                completedPools.map((pool: any, index: number) => (
                    ...
                    <StyledCompletedSalesTd>
                      <StyledFlex gap="10px" style={{ paddingLeft: 20 }}>
                        ...
                        <StyledFlex flexDirection="column" alignItems="flex-start" gap="4px">
                          ...
                          <StyledFont color="#979ABE" fontSize="14px" fontWeight="500">
                            {pool.share_token_symbol} Exchange
                          </StyledFont>
                        </StyledFlex>
                      </StyledFlex>
                    </StyledCompletedSalesTd>
                    <StyledCompletedSalesTd>
                      <StyledFont color="#47C33C" fontSize="16px" fontWeight="500">
                        {formatValueDecimal(pool?.rate_return_usd ?? 0)}%
                      </StyledFont>
                    </StyledCompletedSalesTd>
                    <StyledCompletedSalesTd>
                      <StyledFont color="#FFF" fontSize="16px" fontWeight="500">
                        {formatValueDecimal(pool?.funds_raised_usd ?? 0, '$', 2)}
                      </StyledFont>
                    </StyledCompletedSalesTd>
                    <StyledCompletedSalesTd>
                      <StyledFont color="#FFF" fontSize="16px" fontWeight="500">
                        {formatValueDecimal(pool?.participants ?? 0)}
                      </StyledFont>
                    </StyledCompletedSalesTd>
                    ...
                    <StyledCompletedSalesTd>
                      <StyledFlex style={{ width: '100%', paddingRight: 23 }}>
                        <StyledFlex flexDirection="column" gap="4px">
                          <StyledFont color="#FFF" fontSize="16px" fontWeight="500">
                            {format(new Date(pool.start_time * 1000), 'do LLL yyyy')}
                          </StyledFont>
                          <StyledFont color="#979ABE" fontSize="14px" fontWeight="500">
                            {format(new Date(pool.start_time * 1000), 'HH:mm aa')} - UTC
                          </StyledFont>
                        </StyledFlex>
