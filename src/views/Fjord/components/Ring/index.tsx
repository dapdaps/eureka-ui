    ...
    <StyledRing>
      <StyledSvg>
        <svg xmlns="http://www.w3.org/200/svg" height="45" width="45">
          <circle cx="22.5" cy="22.5" r="17.5" fill="none" stroke="#373A53" stroke-width="5" stroke-linecap="round"></circle>
          <circle style={{ transformOrigin: '22.5px 22.5px', transform: 'rotate(-90deg)' }} cx="22.5" cy="22.5" r="17.5" fill="none" stroke-width="5" stroke-linecap="round" stroke="#FFF" stroke-dasharray={getStrokeDasharray(props?.percent ?? 0)}></circle>
        </svg>
      </StyledSvg>
