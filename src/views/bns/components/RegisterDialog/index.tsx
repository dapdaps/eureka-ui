        ...
        {registerStatus === 0 || registerStatus === 1 ? (
          <StyledDialogBody>
            <StyledFlex $direction="column" $gap="14px" style={{ marginBottom: 27 }}>
              ...
              <StyledText $size="26px" $weight="500" style={{ maxWidth: 360, textAlign: 'center' }}>
                {priceLabel.label}.base
              </StyledText>
            </StyledFlex>
            <StyledInputNumber>
              <StyledInputNumberButton disabled={year === 1} onClick={() => handleMinus()}>
                -
              </StyledInputNumberButton>
              <StyledText $size="16px" $line="120%" style={{ flex: 1, textAlign: 'center' }}>
                {year} Year
              </StyledText>
                ...
                <StyledFlex $justify="space-between" style={{ width: '100%' }}>
                  <StyledFlex $gap="9px">
                    ...
                    <StyledButton
                      ...
                      $borderWidth="0px"
                    >
                      <StyledText $size="14px" $line="120%">
                        60% off
                      </StyledText>
                    </StyledButton>
                  </StyledFlex>
                  <StyledText $size="16px" $line="120%">
                    -${balanceFormated(discountPrice, 2)}
                  </StyledText>
                </StyledFlex>
              ) : (
                <StyledFlex $justify="space-between" style={{ width: '100%', opacity: 0.5 }}>
                  <StyledText $color="#979ABE" $size="16px" $line="120%">
                    DapDap Discount
                  </StyledText>
                  <StyledText $color="#979ABE" $size="16px" $line="120%">
                    -${balanceFormated(discountPrice, 2)}
            ...
            <StyledFlex $direction="column" $gap="15px">
              {discount ? (
                <StyledButton $background="#373A53" $borderRadius="12px">
                  <StyledText $size="16px" $weight="500" $line="12px">
                    You’ve got price on 60% off
                  </StyledText>
                </StyledButton>
              ) : (
                <StyledButton
