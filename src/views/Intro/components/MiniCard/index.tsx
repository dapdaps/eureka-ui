...
const WhiteRightSvg = (
  <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
    ...
    <path
      d="M19.0715 33.0715L33.2136 18.9294M33.2136 18.9294L19.0708 18.9292M33.2136 18.9294L33.2136 33.0716"
      stroke="black"
      stroke-width="2"
...
export default memo(function MiniCard() {
  ...
  useEffect(() => {
    ...
    if (target) {
      handleMouseEnterAnimateRunning(
        target?.querySelector('.SuperBridgeMiniCard'),
        target?.querySelector('.SuperBridgeSvg')
      );
      handleMouseEnterAnimateRunning(
        target?.querySelector('.SuperSwapMiniCard'),
        target?.querySelector('.SuperSwapSvg')
      );
    }
  }, []);
  useEffect(() => {
    ...
    const handleTransitionEnd = () => {
      ...
      if (sliders && sliders.length > 0) {
        ...
        const nextDom = Array.from(sliders).find(
          (slider) => Number(slider?.getAttribute('data-index') ?? -1) === nextIndex
        );
        if (nextDom) {
  ...
  return (
    <StyledMiniCardContainer ref={miniCardContainerRef}>
      <StyledFlex gap="14px" style={{ marginBottom: 14 }}>
        ...
        >
          <StyledRightSvg style={{ right: 10, top: 10 }}>{WhiteRightSvg}</StyledRightSvg>
          <StyledAllInOneBg>
            <StyledTiltChainsContainer>
              <StyledTiltChains
                className="swiper-slide"
                style={{
                  transitionDuration: chainsRunning ? '1s' : '0s',
                  transform: `translate(${-POSITIONS[0] * currentIndex}px, ${POSITIONS[1] * currentIndex}px)`
                }}
              >
                {TILT_CHAINS.map((chain, index) => (
                  <StyledTiltChain
                    key={index}
                    data-index={index}
                    className={['swiper-item', index === currentIndex % TILT_CHAINS.length ? 'current' : ''].join(' ')}
                    src={chain.icon}
                    style={{ left: POSITIONS[0] * index, top: -POSITIONS[1] * index }}
                  />
                ))}
              </StyledTiltChains>
            </StyledTiltChainsContainer>
            ...
            <StyledRockerContainer>
              <StyledRockerImage
                src="/images/intro/allinone/rocker.png"
                className={rockerRunning ? 'running' : ''}
                onClick={handleClickRocker}
              />
              {!rockerRunning && (
          ...
          <StyledContainer style={{ position: 'absolute', width: 302, right: 33, bottom: 59 }}>
            <StyledFont color="#FFF" fontSize="56px" fontWeight="700" lineHeight="100%">
              All-In-One
            </StyledFont>
            <StyledFont
              color="#FFF"
              ...
              fontWeight="700"
              lineHeight="100%"
              style={{ marginTop: 13, marginBottom: 27 }}
            >
              for 15+ L2s
            </StyledFont>
            <StyledFont color="#FFF" fontSize="18px" fontWeight="500" lineHeight="150%">
              Seamlessly trade, lend, and manage liquidity across multiple networks within a completely unified
              interface, making your Web3 experience smooth and uninterrupted.
            </StyledFont>
          </StyledContainer>
        </StyledMiniCard>
        <StyledFlex flexDirection="column" gap="14px" style={{ flex: 1 }}>
          <StyledFlex gap="14px" style={{ width: '100%' }}>
            ...
            >
              <StyledBlackRoundedSvg style={{ top: 12, left: 12 }}>{RoundedSvg}</StyledBlackRoundedSvg>
              ...
              <StyledContainer style={{ paddingTop: 67 }}>
                <StyledFlex gap="6px" style={{ paddingLeft: 24, marginBottom: 14 }}>
                  ...
                  <StyledFont color="#000" fontSize="26px" fontWeight="700" lineHeight="100%">
                    Super Bridge
                  </StyledFont>
                </StyledFlex>
                <StyledFont
                  ...
                  fontWeight="500"
                  lineHeight="150%"
                  style={{ width: 322, paddingLeft: 33, opacity: 0.8 }}
                >
                  One UI to rule them all: Super Bridge aggregates routes from 18+ top bridges, ensuring you always
            ...
            >
              <StyledWhiteRoundedSvg style={{ top: 12, left: 12 }}>{RoundedSvg}</StyledWhiteRoundedSvg>
              ...
              <StyledContainer style={{ paddingTop: 67 }}>
                ...
                <StyledFont
                  ...
                  style={{ width: 322, paddingLeft: 33, opacity: 0.8 }}
                >
                  One UI to rule them all: Super Swap aggregates providers from 75+ of the most popular DEXes,
                  guaranteeing your trades always take the best routes!
                </StyledFont>
              </StyledContainer>
            </StyledMiniCard>
          </StyledFlex>
          <StyledContainer style={{ width: '100%' }}>
            <StyledMiniCard
              style={{
                background: `#EBF479 url(/images/intro/portfolio-bg.svg) no-repeat center`,
                backgroundSize: '100%'
              }}
              onClick={() => {
            ...
            >
              <StyledContainer style={{ paddingTop: 48, paddingLeft: 32, paddingRight: 25 }}>
                <StyledRightSvg style={{ right: 10, top: 10 }}>{BlackRightSvg}</StyledRightSvg>
                ...
                <StyledFont
                  ...
                  fontWeight="500"
                  lineHeight="150%"
                  style={{ marginTop: 31, marginBottom: 22 }}
                >
                  Effortlessly view and manage your assets across networks. Track your bridging, swapping, liquidity,
                  and lending activities in real-time with our comprehensive data support.
                </StyledFont>
                <StyledFlex gap="10px">
                    ...
                    <StyledSvg>
                      <svg xmlns="http://www.w3.org/2000/svg" width="17" height="15" viewBox="0 0 17 15" fill="none">
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M0.000121621 3.62261C-1.62888e-05 3.6226 -3.66687e-05 3.6226 5.92328e-05 3.6226V0C0.634175 0 1.37268 0.184967 2.09001 0.44824C2.84274 0.724506 3.69817 1.13393 4.59563 1.68403C6.39086 2.78442 8.41188 4.48325 10.1413 6.9028C12.9487 10.8305 15.9264 11.3774 17 11.3774V15C14.8574 15 10.8132 13.9436 7.31823 9.0539C5.89643 7.06471 4.24179 5.68002 2.80456 4.79907C2.0858 4.3585 1.4358 4.0528 0.914865 3.86161C0.654561 3.76607 0.43763 3.70322 0.26949 3.66554C0.186006 3.64682 0.120091 3.63556 0.0712859 3.62921C0.0246953 3.62315 0.0019605 3.62265 0.000121621 3.62261Z"
                          fill="#EBF479"
                        />
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M5.16869 9.40994C2.83695 11.1348 0.675467 11.6191 0 11.6191V15C1.62183 15 4.5144 14.1561 7.30521 12.0917L5.16869 9.40994ZM13.173 2.18196C11.9247 2.86261 10.6453 3.80061 9.53594 4.86955L12.0169 7.26018C12.9125 6.39721 13.9407 5.64798 14.901 5.1244C15.9136 4.57223 16.6488 4.38086 17 4.38086V1C15.7431 1 14.3689 1.52989 13.173 2.18196Z"
                          fill="#979ABE"
                        />
                      </svg>
                    </StyledSvg>
                    ...
                    <StyledSvg>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="19" viewBox="0 0 16 19" fill="none">
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M9.80193 10.1848C13.4711 9.28616 14.3966 11.383 14.1621 11.1765C14.1621 10.5794 13.8617 9.67863 13.1648 8.51671C12.4938 7.39823 11.5731 6.22921 10.6119 5.14588C9.66921 4.08348 8.72121 3.14099 8 2.45689C7.27879 3.14099 6.33079 4.08348 5.38812 5.14588C4.42687 6.22921 3.50615 7.39823 2.83524 8.51671C2.13827 9.67863 1.83786 10.5794 1.83786 11.1765C1.83786 14.5047 6.73883 10.935 9.80193 10.1848ZM8 19C12.4183 19 16 15.4973 16 11.1765C16 6.85565 8 0 8 0C8 0 0 6.85565 0 11.1765C0 15.4973 3.58172 19 8 19Z"
                          fill="#EBF479"
                        />
                      </svg>
                    </StyledSvg>
      ...
      <StyledFlex gap="14px">
        ...
        <StyledMiniCard style={{ backgroundColor: '#5B56F3' }}>
          <StyledMiniCardImage
            src="/images/intro/rewards-bg.png"
            style={{ position: 'absolute', width: 405, right: 0, top: 0 }}
          />
          <StyledContainer style={{ paddingTop: 94, paddingLeft: 35 }}>
            <StyledFont color="#FFF" fontSize="36px" fontWeight="700" lineHeight="150%">
              Earnig Rewards
            </StyledFont>
            <StyledFont color="#FFF" fontSize="26px" fontWeight="700" lineHeight="150%">
              While Exploring
            </StyledFont>
          </StyledContainer>
        </StyledMiniCard>
