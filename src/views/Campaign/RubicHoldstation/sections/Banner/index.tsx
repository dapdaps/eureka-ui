...
import { StyledBanner, StyledContainer, StyledSubTitle, StyledTitle } from './styles';
      ...
      <StyledBanner>
        <div>
          ...
          <StyledTitle>
            ...
            <span>Holdstation Campaign</span>
          </StyledTitle>
          <StyledSubTitle>Play Lottery and Win Medals</StyledSubTitle>
        </div>
        <Image
