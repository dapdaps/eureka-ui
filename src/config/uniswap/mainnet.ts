export default {
  ...
  tokens: {
    ...
    '0xA219439258ca9da29E9Cc4cE5596924745e12B93': {
      ...
      name: 'USDT',
      symbol: 'USDT',
      icon: `https://assets.dapdap.tech/images/${'0xA219439258ca9da29E9Cc4cE5596924745e12B93'.toLowerCase()}.png`,
      decimals: 6,
    },
    '0x176211869cA2b568f2A7D4EE941E073a821EE1ff': {
      ...
      symbol: 'USDC',
      name: 'USD Coin',
      icon: `https://assets.dapdap.tech/images/${'0x176211869cA2b568f2A7D4EE941E073a821EE1ff'.toLowerCase()}.png`,
    },
    '0x6bAA318CF7C51C76e17ae1EbE9Bbff96AE017aCB': {
      ...
      name: 'ApeCoin',
      symbol: 'APE',
      icon: `https://assets.dapdap.tech/images/${'0x6bAA318CF7C51C76e17ae1EbE9Bbff96AE017aCB'.toLowerCase()}.png`,
      decimals: 18,
    },
    '0x4AF15ec2A0BD43Db75dd04E62FAA3B8EF36b00d5': {
      ...
      symbol: 'DAI',
      name: 'Dai Stablecoin',
      icon: `https://assets.dapdap.tech/images/${'0x4AF15ec2A0BD43Db75dd04E62FAA3B8EF36b00d5'.toLowerCase()}.png`,
    },
    '0x0e5F2ee8C29e7eBc14e45dA7FF90566d8c407dB7': {
      ...
      symbol: 'HAPI',
      name: 'HAPI',
      icon: `https://assets.dapdap.tech/images/${'0x0e5F2ee8C29e7eBc14e45dA7FF90566d8c407dB7'.toLowerCase()}.png`,
    },
    '0x3b2F62d42DB19B30588648bf1c184865D4C3B1D6': {
      ...
      symbol: 'KNC',
      icon: `https://assets.dapdap.tech/images/${'0x3b2F62d42DB19B30588648bf1c184865D4C3B1D6'.toLowerCase()}.png`,
      decimals: 18,
    },
    '0x0e076AAFd86a71dCEAC65508DAF975425c9D0cB6': {
      ...
      symbol: 'LDO',
      name: 'Lido DAO Token',
      icon: `https://assets.dapdap.tech/images/${'0x0e076AAFd86a71dCEAC65508DAF975425c9D0cB6'.toLowerCase()}.png`,
    },
    '0x5B16228B94b68C7cE33AF2ACc5663eBdE4dCFA2d': {
      ...
      symbol: 'LINK',
      icon: `https://assets.dapdap.tech/images/${'0x5B16228B94b68C7cE33AF2ACc5663eBdE4dCFA2d'.toLowerCase()}.png`,
      decimals: 18,
    },
    '0x7da14988E4f390C2E34ed41DF1814467D3aDe0c3': {
      ...
      symbol: 'PEPE',
      name: 'Pepe',
      icon: `https://assets.dapdap.tech/images/${'0x7da14988E4f390C2E34ed41DF1814467D3aDe0c3'.toLowerCase()}.png`,
    },
    '0x99AD925C1Dc14Ac7cc6ca1244eeF8043C74E99d5': {
      ...
      name: 'SHIBA INU',
      symbol: 'SHIB',
      icon: `https://assets.dapdap.tech/images/${'0x99AD925C1Dc14Ac7cc6ca1244eeF8043C74E99d5'.toLowerCase()}.png`,
      decimals: 18,
    },
    '0x636B22bC471c955A8DB60f28D4795066a8201fa3': {
      ...
      symbol: 'UNI',
      name: 'Uniswap',
      icon: `https://assets.dapdap.tech/images/${'0x636B22bC471c955A8DB60f28D4795066a8201fa3'.toLowerCase()}.png`,
    },
    '0x3aAB2285ddcDdaD8edf438C1bAB47e1a9D05a9b4': {
      ...
      name: 'Wrapped BTC',
      symbol: 'WBTC',
      icon: `https://assets.dapdap.tech/images/${'0x3aAB2285ddcDdaD8edf438C1bAB47e1a9D05a9b4'.toLowerCase()}.png`,
      decimals: 8,
    },
