...
const networks = {
  ...
  59144: {
    ...
    rawMarkets: [
      ...
      {
        id: '5',
        underlyingAsset: linea['mai'].address,
        icon: linea['mai'].icon,
        decimals: linea['mai'].decimals,
        symbol: linea['mai'].symbol,
        name: linea['mai'].name,
        supplyAPY: '',
        usageAsCollateralEnabled: true,
        borrowingEnabled: true,
      ...
      {
        id: '5',
        underlyingAsset: linea['grai'].address,
        icon: linea['grai'].icon,
        decimals: linea['grai'].decimals,
        symbol: linea['grai'].symbol,
        name: linea['grai'].name,
        supplyAPY: '',
        usageAsCollateralEnabled: true,
        borrowingEnabled: true,
        aTokenAddress: '0xE7e54ca3D6F8a5561f8cee361260E537BDc5bE48',
