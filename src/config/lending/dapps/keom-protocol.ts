...
const basic = {
  name: 'Keom Protocol',
  icon: '/assets/apps/keom-protocol.png',
...
const networks = {
  1101: {
    unitrollerAddress: '0x6EA32f626e3A5c41547235ebBdf861526e11f482',
    collateralAddress: '0x6EA32f626e3A5c41547235ebBdf861526e11f482',
