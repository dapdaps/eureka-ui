  ...
  43114: {
    ...
    rawMarkets: [
      ...
      },
      {
        ...
        icon: avalanche['avax'].icon,
        decimals: avalanche['avax'].decimals,
        symbol: avalanche['avax'].symbol,
        name: avalanche['avax'].name,
        supplyAPY: '',
        usageAsCollateralEnabled: true,
        borrowingEnabled: true,
    ...
    rawMarkets: [
      {
        ...
        symbol: polygon['matic'].symbol,
        name: polygon['matic'].name,
        supplyAPY: '',
        usageAsCollateralEnabled: true,
        borrowingEnabled: true,
        aTokenAddress: '0x6d80113e533a2C0fe82EaBD35f1875DcEA89Ea97',
