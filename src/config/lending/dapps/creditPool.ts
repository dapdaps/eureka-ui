    ...
    rawMarkets: [
      {
        ...
        icon: arbitrum['weth'].icon,
        decimals: arbitrum['weth'].decimals,
        name: arbitrum['weth'].name,
        symbol: arbitrum['weth'].symbol,
        supplyAPY: '',
        usageAsCollateralEnabled: true,
        borrowingEnabled: true,
