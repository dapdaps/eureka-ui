export const dapps = [
  {
    ...
    logo: '/assets/images/bafkreiggpt4eld46yk6i5u7cty7zwmcuiq3wx6jkopcm3sxgzqoujoj6iy.png',
    dappSrc: {
  ...
  },
  {
    ...
    on_chain_ids: [5000], // get chain config from chains.ts
    DEFAULT_CHAIN_ID: 5000,
    logo: '/assets/images/bafkreidzxjgiaisjnva6rjdsvcr5f4urskismfu4dljfyby5l3hxdnjx5u.svg',
    extendProps: {
  ...
  },
  {
    ...
    TBD_TOKEN: 'Y',
    logo: '/assets/images/bafkreic6yr27mq42yx6o4fklwbkl5r6dvwc2x5elri6zczye7uskvrlc5e.svg',
    description:
...

  {
    ...
    DEFAULT_CHAIN_ID: 5000,
    logo: '/assets/images/bafkreictpy7n6edfe5boqidwwowccjv4cppterjxtp3ou3wdxagl6adiou.svg',
    dappSrc: {
      5000: 'dapdapbos.near/widget/DappEntry.MantleSwap',
      59144: 'dapdapbos.near/widget/DappEntry.LineaSwap'
    } as { [key: number]: string },
    icon: '/assets/images/bafkreifsgwu2zd6y2n5alekr5qgdhzoivlkl5wujtq3z7gnm5pw4jy7sgi.png'
  },

  {
    ...
    logo: '/assets/images/bafkreicqpts7rramccqvvw7tajq5ax56ssxbs7dspxipbxxov4d6zucbw4.svg',
    dappSrc: {
      59144: 'dapdapbos.near/widget/DappEntry.LineaSwap',
...

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreidwg3iip6lpy24x73e2eopoyib6sc36cqwaljfnjig4nnrelj7a5a.avif',
  ...
  },
  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreia6o7raj6x55wmkt4hxjjul6ydz2oq32olfgco4xw67xzgvxsbxa4.svg',
    description:
  ...
  },
  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreieeeqe7h7ehtxt3jjaqwyqxgzdpqjzv5vkk3zbx7lsh7kxqtv547m.svg',
...

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreidhivnirorddkdudcd6oca6gvhps66audqn3lppsoehlyvorf6p4i.png',
    description:
...

  {
    ...
    DEFAULT_CHAIN_ID: 56,
    logo: '/assets/images/bafkreifyozbu3f42todc2pz7pgeoqiaz2upfis7voy3tk4v3zcxetxva3y.png',
    dappSrc: {
      56: 'dapdapbos.near/widget/DappEntry.BSCSwap'
    } as { [key: number]: string }
  },

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreid3zf4c6chl56k3zz53u6jajnhgha3c5trrixgczmzpqpedhkhfxe.svg',
...

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreid76v6okuhmrsj7qztgnvnxedob3ibrttwiaivnxaxptnow23y6t4.svg',
...

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreibmy53ll3pjjs2ts7lvhlmcsoaped5qipdai3dgyb4xx3uxksdtlm.svg',
...

  {
    ...
    logo: '/assets/images/bafkreibo6w6552c3xwppsaqmnfku4pforczds45ueibsrt34zj2xcpi76u.jpeg',
    tags: ['Dexes'],
    type: 'dex',
    on_chain_ids: [42161], // get chain config from chains.ts
    DEFAULT_CHAIN_ID: 42161,
...

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreihlykr7jjajj4ddm6uxxu3n44n2p7s4cc2issd46fnr37kwco7alu.svg',
    description:
...

  {
    ...
    logo: '/assets/images/bafkreifeodttoaen6redxzqxz7jvqdmsnmncsnrmjxtxgporsacy4ku6ea.svg',
    TBD_TOKEN: 'N',
    description:
...

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreigwgzvlmztx4a4z4qcwyrxof23gghs7zl4ujqqztgmezgydnsgape.svg',
    description:
...

  {
    ...
    tags: ['Dexes'],
    logo: '/assets/images/bafkreicod5xxs5sirml6rgxrrhqbc4vlsusedr7t4semrmdaloqukxjs6a.svg',
    type: 'dex',
    on_chain_ids: [42161], // get chain config from chains.ts
    DEFAULT_CHAIN_ID: 42161,
    dappSrc: {
...

  {
    ...
    logo: '/assets/images/bafkreidgayoqzg4kqxz6eag4eridejkx3rszflfwbnitfqfohlmpk54w3i.svg',
    TBD_TOKEN: 'N',
    description: 'The native liquidity layer on Arbitrum',
    tags: ['Dexes'],
    type: 'dex',
...

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreiekp7osfgpzfcboawj7yj3mirxxaxwcbvdkb5mgpbui6boz47dhoy.svg',
    description:
...

  {
    ...
    logo: '/assets/images/bafkreihltljvxhpi7zszyc67wsinxzcj2fakufti6koeoelst74av7j4eq.svg',
    TBD_TOKEN: 'N',
    description:
...

  {
    ...
    TBD_TOKEN: 'N',
    logo: '/assets/images/bafkreibox4d5bhaw2hvgf4m42acvuvzbmdaufoy53grhffyuaz5pafcbse.svg',
...

  {
    ...
    logo: '/assets/images/bafkreiaqpbeth37uxmbe6iwqduoad76dncozbuoa3bwgcbcxcmputkuzfu.png',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreibdq7fvaobgp6tuna5k2s7u43mkecy4jeumbfw3lgwrd2ft2uftoe.svg',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreicoh23atiwall72voi6xchtqq4cmvfm2z5ge257ynw5hvkspyod2e.svg',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreie7ikpsbxhjkvwuhwhfyt7exssk7m36wnjdeasnvpxn4lzxjeq4da.png',
    TBD_TOKEN: 'N',
    description:
  ...
  },
  {
    ...
    logo: '/assets/images/bafkreiag326f7l2dfyoy7iivyr27e34ockcu5yktb75xvz2ppnn5dfyap4.png',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreidhzpw4f3j2ufxxnqapfc4zyeythbds4uop44dbgnfnk2ymqgp7aa.png',
    TBD_TOKEN: 'Y',
...

  {
    ...
    logo: '/assets/images/bafkreicagi5msm7flwzqkgemb6odyx6r4jbhnvrhustzyuboznh6rr6bbu.png',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreibwn7ekxtgnkczolfnwpjemz4hdm27mftcnd4yqjocvdvlw7nb4sm.png',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreig6xa6pd2za7xxssj5ul7xfx7mvfayjnqvxvxgmv6hgeb6pya43cm.png',
    TBD_TOKEN: 'N',
    description:
...

  {
    ...
    logo: '/assets/images/bafkreiaudgxte56nl6eedzg6inp4w3xobp25chpayt3ojuiblhzkzgsifq.png',
    TBD_TOKEN: 'Y',
    description:
...

  {
    ...
    logo: '/assets/images/bafkreibj5orc77anv4ys5dpallk4u27e52gvosxcdbcm5curxlw3ffmhsy.png',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreidqfdregtnl6vbpuvdp5g2fvekuz24zti4owzgjzkgz5n7nfmoafq.png',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreih5p5podfnagabzxizmsje2y2qhccfjspxuvgkcexkunqsy7v7j64.png',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreih2qmod4k2buqgbg4yayyo4t353za2tknxw5xb272x4fekqtbwjve.png',
    TBD_TOKEN: 'N',
    description:
...

  {
    ...
    logo: '/assets/images/bafkreifziawsf2l5nvz5eak2csyhp3ln7ldij53clfaxptbx7353uwone4.png',
    TBD_TOKEN: 'N',
    description:
...

  {
    ...
    logo: '/assets/images/bafkreihivtnhg2bi44rrmuxyefnobbqnons23ha5bwzekfqatew4z2bda4.png',
    TBD_TOKEN: 'N',
...

  {
    ...
    logo: '/assets/images/bafkreicvlu4cwvtx6vwasc2vzzfnkmmkgrwn34zk42mogacvklxh3yav7e.png',
    TBD_TOKEN: 'N',
  ...
  },
  {
    ...
    logo: '/assets/images/bafkreida3sat55yql3apjhngucnilyf7qck6ji32pekkoc2rrg4habf4va.png',
    TBD_TOKEN: 'N',
    description:
  ...
  },
  {
    ...
    logo: '/assets/images/bafkreib4zhl7kkpllunevcepxzmrge75halcj57th7ksxkpf5bqcxzciy4.png',
    TBD_TOKEN: 'N',
  ...
  //   logo: '/assets/images/bafkreiedaqqpcuw6oj5mao263fizx3gksybdmw5x2p7xeka7wngzip5zeu.png',
  //   TBD_TOKEN: 'N',
  //   description:
  ...
  // },
  {
    ...
    logo: '/assets/images/bafkreibwvipasq4updgsl354x7m7y5yy7ypwort5v7xcxusg2uy5voz2xy.svg',
    TBD_TOKEN: 'N',
