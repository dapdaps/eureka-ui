...
export const bsc: { [key: string]: Token } = {
  ...
  tfil: {
    chainId: CHAIN_ID,
    address: '0x7829a9810BB84b0e6827f21c81396125d76a2EAB',
    decimals: 18,
    symbol: 'tFIL',
    name: 'tFIL',
  ...
  reth: {
    chainId: CHAIN_ID,
    address: '0xa7A0A9FDA65Cd786b3DC718616cEe25afB110544',
    decimals: 18,
    symbol: 'rETH',
    name: 'StaFi',
  ...
  rdot: {
    chainId: CHAIN_ID,
    address: '0x1daB2A526C8AC1DdEa86838A7B968626988D33dE',
    decimals: 18,
    symbol: 'rDOT',
    name: 'StaFi',
